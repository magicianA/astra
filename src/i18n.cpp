...
constexpr auto entries = std::to_array<Translation>({
    ...
    {"黑夜", "Night"},
    {"恢复昼夜变化", "Restore day & night"},
    {"大气已关闭，白天也会显示星空。", "Atmosphere is off: stars remain visible during the day."},
    {"关闭后不渲染大气，白天也会显示星空。",
     "Disabling the atmosphere leaves stars visible even during daylight."},
    {"启用大气与自动曝光，曝光补偿恢复为 0 EV。",
     "Enables atmosphere and automatic exposure, and resets compensation to 0 EV."},
